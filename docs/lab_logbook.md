...
This logbook documents the step-by-step development process of the ML-powered FoodPulse recommendation system. It serves as a transparent record of decisions, experiments, and learnings.
