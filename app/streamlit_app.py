...
def main():
    ...
    # Header
    st.markdown('<h1 class="main-header">⚡ FoodPulse — AI-Powered Restaurant Recommendations</h1>', unsafe_allow_html=True)
    ...
    with st.sidebar:
        ...
        st.markdown(
            ...
            <div style='text-align: center; color: #6b7280; font-size: 0.8rem;'>
                © 2026 <strong>FoodPulse</strong><br>
...
st.markdown("""
    <div style='text-align: center; color: #6b7280; padding: 20px;'>
        <p>⚡ <strong>FoodPulse — AI-Powered Restaurant Recommendation & Experimentation</strong> - Hybrid AI System • 40% Faster Decisions • Explainable</p>
        <p>Built with Python, Streamlit, Scikit-learn, Pandas, NumPy, SciPy & Plotly <strong>| Last Updated:</strong> {}</p>
        <p>© 2026 <strong>FoodPulse</strong>. Built for intelligent food discovery and experimentation.</p>
    </div>
